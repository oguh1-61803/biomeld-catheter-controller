...
from client.hyperneat.HyperNEATEvaluator import HyperNEATEvaluator
...
# configuration file. It also receives the configuration of: the substrate, CPPNs, the GA, the fitness function,
# the server data.
class ControllerHyperNEAT:

    FITTEST_PATH = "fittest/"

    # Constructor
    def __init__(self, path_data, substrate_data, cppn_data, ga_data, fitness_metrics, server_configuration):
        ...
        self.__configure_fitness_function(path_data, substrate_data, fitness_metrics, server_configuration, cppn_data,
    ...
    def execute_algorithm(self, experiment_id):
        ...
        fittest_substrate_network = self.fitness_function.build_substrate(fittest_cppn)
    ...
    def __configure_fitness_function(self, path_data, substrate_data, fitness_data, server_data, cppn_data,
                                     number_of_individuals):

        catheter_path = path_data.get("catheters_path")
        self.fitness_function = HyperNEATEvaluator(catheter_path, substrate_data, fitness_data, server_data, cppn_data,
                                                   number_of_individuals)
