...
from client.hyperneat.Neuron import Neuron
...
class Substrate:
    ...
    # Constant values required to generate bias and weights for the substrate.
    RESPONSE = 1.0
    ...
    def __initialise_neurons(self, substrate_data):
        ...
        n4 = Neuron(-4, (1.0, y_axis))
        self.input_layer.append(n3)

        neuron_id = 0
        y_axis = len(substrate_data.get("hidden_ranges"))
        n4 = Neuron(neuron_id, (0.0, y_axis))
